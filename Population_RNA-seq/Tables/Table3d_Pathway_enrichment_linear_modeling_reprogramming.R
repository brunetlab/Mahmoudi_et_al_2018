...
###################################################################################################
setwd('~/Dropbox/Code_checking_SM/For_Brittany/Tables/Extended_Data_Table_x_pathway_enrichment_linear_modeling_RE/')

# Load data
load("~/Dropbox/Code_checking_SM/For_Brittany/Core_Analysis/Fibroblast_in_vitro_linear_modeling_RE/DESeq2_Linear_modeling_RE_young_old.Rda")
...
write.csv(kegg.results.change.w.age$pathway.results,
          file = "kegg.results.pathways.linear_modeling_young_old_RE_180805.csv", row.names = T)
